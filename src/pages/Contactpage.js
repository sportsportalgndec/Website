...
const homeSlides = [
  {
    ...
    line1Color: "#ffffff",
    line2Color: "#778fff",
    line1Text: " SHARING THOUGHTS",
    line2Text: "SHAPING FUTURES ",
  },
  {
    bg: sportsBg2,
    player: player2,
  ...
  },
  {
    ...
    textStyle: { top: "22vh", right: "4%", fontSize: "4.5vw" },
    mobileStyle: { 
      top: "45%", 
      left: "4%", 
      transform: "translate(0%, -50%)", 
  ...
  },
  {
    ...
    textStyle: { top: "22vh", left: "2%", fontSize: "4vw" },
    mobileStyle: { 
      top: "40%", 
      right: "5%", 
      transform: "translateY(-50%)", 
  ...
  // Slides 5-8
  {
    ...
    textStyle: { top: "22vh", right: "2%", fontSize: "4.2vw" },
  ...
  },
  {
    ...
    textStyle: { top: "22vh", left: "1%", fontSize: "4.1vw" },
  ...
  },
  {
    ...
    textStyle: { top: "22vh", right: "3%", fontSize: "4vw" },
